...
model_01.fit(x_train_noised, x_train, epochs = 30, batch_size = 128, validation_split = 0.2)
decoded_imgs_01 = model_01.predict(x_test_noised)


print('================== node 8개 시작 =====================')
model_08.compile(optimizer = 'adam', loss = 'mse', )
model_08.fit(x_train_noised, x_train, epochs = 30, batch_size = 128, validation_split = 0.2)
decoded_imgs_08 = model_08.predict(x_test_noised)


print('================== node 32개 시작 =====================')
model_32.compile(optimizer = 'adam', loss = 'mse', )
model_32.fit(x_train_noised, x_train, epochs = 30, batch_size = 128, validation_split = 0.2)
decoded_imgs_32 = model_32.predict(x_test_noised)


print('================== node 64개 시작 =====================')
model_64.compile(optimizer = 'adam', loss = 'mse', )
model_64.fit(x_train_noised, x_train, epochs = 30, batch_size = 128, validation_split = 0.2)
decoded_imgs_64 = model_64.predict(x_test_noised)


print('================== node 154개 시작 =====================')
model_154.compile(optimizer = 'adam', loss = 'mse', )
model_154.fit(x_train_noised, x_train, epochs = 30, batch_size = 128, validation_split = 0.2)
decoded_imgs_154 = model_154.predict(x_test_noised)


print('================== node 331개 시작 =====================')
model_331.compile(optimizer = 'adam', loss = 'mse', )
model_331.fit(x_train_noised, x_train, epochs = 30, batch_size = 128, validation_split = 0.2)
decoded_imgs_331 = model_331.predict(x_test_noised)


print('================== node 486개 시작 =====================')
model_486.compile(optimizer = 'adam', loss = 'mse', )
model_486.fit(x_train_noised, x_train, epochs = 30, batch_size = 128, validation_split = 0.2)
decoded_imgs_486 = model_486.predict(x_test_noised)


print('================== node 713개 시작 =====================')
model_713.compile(optimizer = 'adam', loss = 'mse', )
model_713.fit(x_train_noised, x_train, epochs = 30, batch_size = 128, validation_split = 0.2)
...
for row_num, row in enumerate(axes):
    for col_num, ax in enumerate(row):
        ...
        ax.grid(False)
        if row_num ==0:
            ax.set_ylabel(outputs[row_num], size=20)
        ax.set_xticks([])
        ax.set_yticks([])
plt.show()
