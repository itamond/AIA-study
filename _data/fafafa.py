...
for k in range(48890,51000):
    
    train_x, val_x, train_y, val_y = train_test_split(train_x, train_y,test_size=0.3,shuffle=True,random_state=40891)
    ...
    submission.to_csv(f'./_save/this_{k}.csv', float_format='%.3f')
