...
# for j in range(63):
#     for i in range(72):
#         pred_x = np.concatenate([test_pm[6, 37+i+120j:47+i+120j, :], test_pm_aws[6, 37+i+120j:47+i+120j, :]], axis=1).reshape(1, 10 ,7)
#         pred = model.predict(pred_x)
#         print(pred)
#         test_pm[6, 47+i+120j, 1] = pred

# print(test_pm[0, 38:48, :])
# print(test_pm_aws[0, 38:48, :])

# print(test_pm[0, 39:49, :])
# print(test_pm_aws[0, 39:49, :])
...
#     for j in range(63):
#         for i in range(72):
#             pred_x = model.predict(np.concatenate([test_pm[0, 38+i+120*j:48+i+120*j, :], test_pm_aws[0, 38+i+120*j:48+i+120*j, :]], axis=1).reshape(1, 10 ,7))
#             test_pm[0, 39+i+120*j, 1] = pred_x
...
submission['PM2.5']=a
submission.to_csv('./_data/pm2.5/Aiur_Submit_1.csv')