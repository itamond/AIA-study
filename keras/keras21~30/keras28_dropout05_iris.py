...
outputs1 = Dense(3,activation='softmax')(drop5)
...
mcp = ModelCheckpoint(monitor='val_acc',
                      ...
                      verbose=1,
                      save_best_only=True,
                      filepath=''.join([filepath,'k28_05_',date,'_',filename])
                      )
...
# loss : 0.10145250707864761
# acc : 0.9666666388511658
# acc : 0.9666666666666667  드롭아웃 적용