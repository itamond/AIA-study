...
dense4 = Dense(12,activation='relu')(drop3)
drop4 = Dropout(0.2)(dense4)
dense5 = Dense(8,activation='relu')(drop4)
drop5 = Dropout(0.2)(dense5)
dense6 = Dense(6,activation='relu')(drop5)
drop6 = Dropout(0.2)(dense6)
dense7 = Dense(8,activation='relu')(drop6)
drop7 = Dropout(0.2)(dense7)
dense8 = Dense(6,activation='relu')(drop7)
...
mcp =ModelCheckpoint(monitor='val_loss',
                     ...
                     verbose=1,
                     save_best_only=True,
                     filepath=''.join([filepath,'28_09_',date,'_',filename]))
...
# loss : 30629.56640625
# r2 : 0.09942513549027321
# rmse : 175.0130427344154  드롭아웃 적용