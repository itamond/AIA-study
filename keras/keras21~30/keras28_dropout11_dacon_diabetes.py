...
filename = '{epoch:04d}-{val_accuracy:.2f}.hdf5'
...
dense2 = Dense(6,activation='relu')(drop1)
...
mcp = ModelCheckpoint(monitor='val_accuracy',
                      ...
                      verbose=1,
                      save_best_only=True,
                      filepath=''.join([filepath,'k28_11_',date,'_',filename]),
                      )
...
submission.to_csv(path_save+'submission_DO_2.csv')
