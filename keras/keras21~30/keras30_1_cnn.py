...
# =================================================================
# conv2d (Conv2D)              (None, 7, 7, 7)           35            param1 = (2x2)(필터 크기) x 1(입력 채널 rgb) x 7 (출력 채널) + bias (출력 채널의 갯수)   =4x1x7 + 7   =35
# _________________________________________________________________
# conv2d_1 (Conv2D)            (None, 5, 5, 4)           256           param2~ = 3x3(필터 크기) x 7(입력 필터) x 4(출력 필터) + bias (출력 필터의 갯수) = 9 x 7 x 4 + 4    = 256
# _________________________________________________________________
