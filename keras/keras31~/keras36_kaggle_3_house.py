...
cols = ['MSZoning', 'Street','LandContour','Neighborhood','Condition1','Condition2',
                ...
                'Utilities','LandSlope','BldgType','HouseStyle','LotConfig','Alley', 'PoolQC', 'Fence', 'MiscFeature']
...
x_train, x_test, y_train, y_test = train_test_split(
    x, y, train_size = 0.8, shuffle = True, random_state = 68)
...
submission.to_csv('./_save/house_price/subtest2.csv')