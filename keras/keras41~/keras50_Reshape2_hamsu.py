...
conv2_1 = Conv2D(filters=64, kernel_size=3, padding='same')(input1)
maxp1 = MaxPooling2D()(conv2_1)
conv2_2 = Conv2D(10, 3)(maxp1)
conv2_3 = Conv2D(10, 3)(conv2_2)
maxp2 = MaxPooling2D()(conv2_3)
flat1 = Flatten()(maxp2)
resha1 = Reshape(target_shape=(25, 10))(flat1)
conv1_1 = Conv1D(10, 3, padding='same')(resha1)
lstm1 = LSTM(250)(conv1_1)
resha2 = Reshape(target_shape=(50, 5, 1))(lstm1)
conv2_4 = Conv2D(32, 3, padding='same')(resha2)
