...
x_train = np.load('d:/study_data/_save/_npy/58_rps_train_x.npy')
y_train = np.load('d:/study_data/_save/_npy/58_rps_train_y.npy')
x_test = np.load('d:/study_data/_save/_npy/58_rps_test_x.npy')
y_test = np.load('d:/study_data/_save/_npy/58_rps_test_y.npy')
