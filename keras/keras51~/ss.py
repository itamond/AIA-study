...
lstm1 = LSTM(16, activation='swish', name='lstm1')(input1)
dense1 = Dense(8, activation='swish', name='dense1')(lstm1)
output1 = Dense(4, name='output1')(dense1)

# 2-2. 모델2
input2 = Input(shape=(timesteps, 10))
lstm2 = LSTM(16, activation='swish', name='lstm2')(input2)
dense11 = Dense(8, activation='swish', name='dense11')(lstm2)
output2 = Dense(4, name='output2')(dense11)

merge1 = concatenate([output1, output2], name='merge1')
merge2 = Dense(20, activation='swish', name='merge2')(merge1)
merge3 = Dense(10, activation='swish', name='merge3')(merge2)
