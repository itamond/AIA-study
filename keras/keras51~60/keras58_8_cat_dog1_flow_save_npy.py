...
np.save('d:/study_data/_save/_npy/58_cat_dog_train_x.npy', arr=x_train1)
np.save('d:/study_data/_save/_npy/58_cat_dog_train_y.npy', arr=y_train2)
np.save('d:/study_data/_save/_npy/58_cat_dog_test_x.npy', arr=x_test)
np.save('d:/study_data/_save/_npy/58_cat_dog_test_y.npy', arr=y_test)
