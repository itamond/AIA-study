...
# 걸린시간 :  4.371129989624023
# model.best_params_ :  {'optimizer': <keras.optimizer_v2.adadelta.Adadelta object at 0x000001C8ED7D0F10>, 'drop': 0.5, 'batch_size': 200, 'activation': 'relu'}
# model.best_estimator :  <keras.wrappers.scikit_learn.KerasClassifier object at 0x000001C895C19FD0>
# model.best_score_ :  0.3692307770252228
# WARNING:tensorflow:6 out of the last 6 calls to <function Model.make_test_function.<locals>.test_function at 0x000001C90E1D03A0> triggered tf.function retracing. Tracing is expensive and the excessive number of tracings could be due to (1) creating @tf.function repeatedly in a loop, (2) passing tensors with different shapes, (3) passing Python objects instead of tensors. For (1), please define your @tf.function outside of the loop. For (2), @tf.function has experimental_relax_shapes=True option that relaxes argument shapes that can avoid unnecessary retracing. For (3), please refer to https://www.tensorflow.org/guide/function#controlling_retracing and https://www.tensorflow.org/api_docs/python/tf/function for  more details.
# 1/1 [==============================] - 0s 50ms/step - loss: nan - accuracy: 0.3860
# model.score :  0.38596490025520325
