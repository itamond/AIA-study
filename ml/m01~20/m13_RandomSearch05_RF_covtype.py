...
# 최적의 매개변수 : RandomForestClassifier(max_depth=12, min_samples_leaf=5, min_samples_split=3,
#                        n_estimators=200)
# 최적의 파라미터 : {'n_estimators': 200, 'min_samples_split': 3, 'min_samples_leaf': 5, 'max_depth': 12}
# best_score_ : 0.7781454334879957
# model.score : 0.7810985947006531
# accuracy_score : 0.7810985947006531
# 최적 튠 ACC: 0.7810985947006531
# 걸린 시간 : 959.31 초