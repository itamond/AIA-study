...
model = HalvingRandomSearchCV(RandomForestClassifier(), parameters,  #그리드서치에서 랜덤하게 뽑아서 쓴다.
                    #  cv=kfold, 
...
#                        n_estimators=200)
# 최적의 파라미터 : {'max_depth': 10, 'min_samples_leaf': 3, 'min_samples_split': 3, 'n_estimators': 200}
...
#                        n_estimators=200)
# 최적의 파라미터 : {'n_estimators': 200, 'min_samples_split': 5, 'min_samples_leaf': 7, 'max_depth': 8}
...
# 최적의 파라미터 : {'max_depth': 6, 'min_samples_leaf': 10, 'min_samples_split': 2, 'n_estimators': 100}
# best_score_ : 0.9640731292517007
# model.score : 0.9122807017543859
# accuracy_score : 0.9122807017543859
# 최적 튠 ACC: 0.9122807017543859
# 걸린 시간 : 15.33 초

# HalvingRandomSearch
# 최적의 매개변수 : RandomForestClassifier(max_depth=10, min_samples_leaf=3, n_estimators=200)
# 최적의 파라미터 : {'n_estimators': 200, 'min_samples_split': 2, 'min_samples_leaf': 3, 'max_depth': 10}
# best_score_ : 0.9641794217687074
