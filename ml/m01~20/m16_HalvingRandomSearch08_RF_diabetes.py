...
model = HalvingRandomSearchCV(RandomForestRegressor(), parameters,  #그리드서치에서 랜덤하게 뽑아서 쓴다.
                    #  cv=kfold, 
...
# 최적의 파라미터 : {'n_estimators': 100, 'min_samples_split': 2, 'min_samples_leaf': 3, 'max_depth': 10}
# best_score_ : 0.41644901049098426
# model.score : 0.43576956301200165
# r2 : 0.43576956301200165
# 최적 튠 r2: 0.43576956301200165
# 걸린 시간 : 12.26 초