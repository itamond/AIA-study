...
# RandomSearch
# 최적의 매개변수 : RandomForestClassifier(max_depth=10, min_samples_leaf=5, n_estimators=200)
# 최적의 파라미터 : {'n_estimators': 200, 'min_samples_split': 2, 'min_samples_leaf': 5, 'max_depth': 10}
...
# HalvingGridSearch
# 최적의 매개변수 : RandomForestClassifier(max_depth=10, min_samples_leaf=5, min_samples_split=3,
#                        n_estimators=200)
# 최적의 파라미터 : {'max_depth': 10, 'min_samples_leaf': 5, 'min_samples_split': 3, 'n_estimators': 200}
# best_score_ : 1.0
