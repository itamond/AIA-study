...
# model.score : 0.7855844310191671
# 최적의 매개변수 : Pipeline(steps=[('std', StandardScaler()),
#                 ('rf',
#                  RandomForestRegressor(max_depth=12, min_samples_leaf=3,
#                                        n_estimators=200))])
# 최적의 파라미터 : {'rf__max_depth': 12, 'rf__min_samples_leaf': 3, 'rf__min_samples_split': 2, 'rf__n_estimators': 200}
# best_score_ : 0.7691407952189654
# model.score : 0.7855844310191671
# r2 : 0.7855844310191671
# 최적 튠 r2: 0.7855844310191671
# 걸린 시간 : 23.1 초