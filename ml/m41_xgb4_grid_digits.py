...
# 최상의 매개변수 : {'colsample_bylevel': 0.2, 'colsample_bynode': 1, 'colsample_bytree': 0.5, 'gamma': 0, 'learning_rate': 0.1, 'max_depth': 4, 'min_child_weight': 0, 'n_estimators': 1000, 'reg_alpha': 1, 'reg_lambda': 1, 'subsample': 0.2}
# 최상의 점수 : 0.9707655826558266
