...
submission.to_csv(path + 'submit_0306_0901.csv')     #저장하는 함수 .to_


# r2 스코어 : 0.6521931775533685
# RMSE : 38.971256382746546

#r2 스코어 : 0.7617253216799983
# RMSE : 32.25628181063114